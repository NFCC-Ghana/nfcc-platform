...
def create_flood_risk_map(district: str = None, risk_level: str = "MODERATE") -> folium.Map:
    """
    ...
    rivers = [
        ...
        {"name": "Odaw", "coords": [[5.55, -0.20], [5.60, -0.20]], "color": "lightblue"},
        {"name": "Densu", "coords": [[5.55, -0.33], [5.60, -0.33]], "color": "lightblue"}
    ]
