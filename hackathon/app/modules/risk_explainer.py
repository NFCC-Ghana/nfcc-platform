...
def get_risk_breakdown(district: str, rainfall: float, soil_saturation: float, river_level: float) -> dict:
...
def render_risk_explainer(district: str, rainfall: float, soil_saturation: float, river_level: float) -> None:
