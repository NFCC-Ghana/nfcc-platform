...
class EmailAlertProvider(BaseAlertProvider):
    ...
    def __init__(self, recipients: list = None, **kwargs):
        ...
        self.smtp_host = kwargs.get("smtp_host", os.getenv("SMTP_HOST", "smtp.gmail.com"))
    ...
    def send(self, payload: AlertPayload) -> Dict[str, Any]:
        ...
        for attempt in range(3):
            try:
                with smtplib.SMTP(self.smtp_host, self.smtp_port) as server:
                    ...
                    msg["Subject"] = f"[NFCC] {payload.risk_tier} Flood Alert — {payload.location}"
                    ...
                    logger.info(
                        ...
                        self.recipients, payload.location, payload.score
                    )
        ...
        return {"success": False, "provider": self.name, "error": "Max retries exceeded"}
