...
class ReservoirIntelligenceEngine:
    ...
    def __init__(self, data_path: str = "data/dams/"):
        ...
        logger.info(f"Reservoir Intelligence Engine initialized with {len(self.dams)} dams")
    ...
    def get_downstream_risk(self, community: str) -> Dict:
        ...
        return {
            ...
            'total_risk': 'HIGH' if any(d['spillage_risk'] == 'HIGH' for d in at_risk) else 'MEDIUM' if at_risk else 'LOW'
        }
