...
class ReservoirIntelligenceEngine:
    """Complete reservoir intelligence with all Ghana dams."""
    ...
    def _load_dams(self) -> Dict:
        ...
        return {
            ...
            # Water Supply Dams - Ashanti Region
            "barekese": {
                "name": "Barekese Dam",
                "river": "Offin River",
                "region": "Ashanti",
            ...
            # Water Supply Dams - Greater Accra
            "weija": {
                "name": "Weija Dam",
                "river": "Densu River",
                "region": "Greater Accra",
    ...
    def _generate_reservoir_data(self, dam_id: str, days: int) -> pd.DataFrame:
        ...
        for date in dates:
            ...
            if month in [5, 6, 7, 9, 10]:
                base_inflow *= 2
            inflow = max(0, base_inflow + np.random.normal(0, 20))
        ...
        return pd.DataFrame(
            {
                ...
                "pct_full": [(l / capacity) * 100 for level_val in levels],
                "inflow_mcm": inflows,
    ...
    def get_dam_status(self, dam_id: str) -> Dict:
        ...
        return {
            ...
            "downstream_communities": dam.get("downstream_communities", []),
        }
