...
class TestSubscriptionsAPI:
    ...
    def test_delete_subscription(self, test_client):
        """Test deleting/unsubscribing a subscription."""
        payload = {
    ...
    def test_list_subscriptions_includes_min_risk_tier_and_location(self, test_client):
        """Test that list includes all subscription fields."""
        payload = {
        ...
        found = next(
            (sub for sub in subscriptions if sub["email"] == payload["email"]), None
        )
    ...
    def test_get_inactive_subscriptions_when_requested(self, test_client):
        """Test that inactive subscriptions can be filtered."""
        payload = {
