...
class MockTwilioClient:
    ...
    def set_error_mode(self, error_type: TwilioErrorType, fail_count: int = 1, delay_ms: int = 0):
        ...
        if self.error_type != TwilioErrorType.NONE:
            ...
            if self.fail_count <= self.max_failures:
                errors = {
                    ...
                    TwilioErrorType.SERVICE_UNAVAILABLE: Exception("Service unavailable"),
                    TwilioErrorType.MESSAGE_TOO_LONG: Exception("Message exceeds 1600 characters"),
                }
