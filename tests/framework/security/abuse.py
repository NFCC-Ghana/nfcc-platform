...
class AbuseTester:
    ...
    @staticmethod
    def rate_limit_abuse(client, endpoint: str, payload: Dict[str, Any], n_requests: int = 1000):
    ...
    @staticmethod
    def concurrent_abuse(client, endpoint: str, payload: Dict[str, Any], n_threads: int = 10, n_per_thread: int = 100):
