...
from tests.framework.plugin import PluginRegistry, TestContext, ChaosPlugin, SecurityPlugin, ObservabilityPlugin
...
class ResiliencePlatform:
    ...
    def __init__(self, client, config: Optional[Dict[str, Any]] = None):
        ...
        self.ci_enforcer = CIEnforcer(threshold_failures=self.config.get("threshold_failures", 0))
