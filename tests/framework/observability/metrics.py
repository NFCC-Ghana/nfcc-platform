...
class MetricsValidator:
    ...
    def record(self, metric_name: str, value: Any, tags: Optional[Dict[str, str]] = None):
    ...
    def assert_increased(self, metric_name: str, from_snapshot: str, to_snapshot: str):
        ...
        assert to_count > from_count, f"Metric {metric_name} did not increase: {from_count} -> {to_count}"
