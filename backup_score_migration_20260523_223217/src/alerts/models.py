...
class AlertPayload:
    ...
    Fields:
        location: Location name (e.g., "Accra Central")
        score: Risk score (0-100) - THIS IS THE ONLY SCORE FIELD
        risk_tier: Risk tier (LOW/MODERATE/HIGH/CRITICAL/EXTREME)
        message: Human-readable alert message
        precipitation: Current precipitation in mm
        roll_3d: 3-day rolling precipitation
        z_score: Statistical z-score for anomaly detection
